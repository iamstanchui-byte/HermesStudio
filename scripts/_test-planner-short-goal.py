"""Try a shorter goal to see if planner succeeds."""
import json
import time
import urllib.request

pid = "proj-48b50520"
# Shorter, more focused goal
short_goal = (
    "Read existing CPI/PPI data and brief from this project folder. "
    "Fetch 24 months of XAUUSD monthly closes from MT5 bridge "
    "(http://localhost:5001/candles/XAUUSD?tf=MN&count=24). "
    "Compute Pearson correlation between monthly CPI/PPI change rates and XAUUSD returns. "
    "Write report_v2.md with the new correlation analysis section."
)
print("=== replan with short goal ===")
req = urllib.request.Request(
    f"http://127.0.0.1:8765/api/projects/{pid}/replan",
    data=json.dumps({"goal": short_goal, "clear_tasks": True}).encode(),
