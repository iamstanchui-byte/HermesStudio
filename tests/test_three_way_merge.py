...
def _plan_v1(pid: str) -> dict:
    return {
        ...
        "variables": [],
        "steps": [
            {"name": "step-a", "agent_role": "super", "action": "do_step", "depends_on": []},
        ],
    }
...
def _plan_v2(pid: str) -> dict:
    return {
        ...
        "variables": [],
        "steps": [
            {"name": "step-b", "agent_role": "super", "action": "do_step", "depends_on": []},
            {"name": "step-c", "agent_role": "super", "action": "do_step", "depends_on": ["step-b"]},
        ],
    }
...
def _plan_v3(pid: str) -> dict:
    return {
        ...
        "variables": [],
        "steps": [
            {"name": "step-d", "agent_role": "super", "action": "do_step", "depends_on": []},
        ],
    }
